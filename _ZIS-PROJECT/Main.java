...
public class Main {
	...
	private static final String PHYSICAL_ADDRESS = "8225 N Wickham Rd, Melbourne, FL 32940";
	private static final String PHONE_NUMBER = "321-254-9453";
	private static final String FAX_NUMBER = "321-259-5966";
	private static final String WEB_ADDRESS = "www.brevardzoo.org";

	// CREATE Zoo CLASS REFERENCE
	Zoo zoo = new Zoo(PHYSICAL_ADDRESS, PHONE_NUMBER, FAX_NUMBER, WEB_ADDRESS,930, 1700,0,0,0);

	// CREATE ArrayList REFERENCE OF DATATYPE Asset
	private static ArrayList<Asset> asset = new ArrayList<Asset>();

	// CREATE ArrayList REFERENCE OF DATATYPE Animal
	private static ArrayList<Animal> animals = new ArrayList<Animal>();

	// CREATE ArrayList REFERENCE OF DATATYPE Staff
	private static ArrayList<Staff> staff = new ArrayList<Staff>();

	// DEFINE CUSTOM DATATYPE CLASSES...
	private static class Zoo {

		// INSTANCE VARIABLES OF Zoo CLASS
		String physicalAddress;					// 120 CHAR MAX
		String phoneNumber;						// 10 DIGITS ###-###-####
		String faxNumber;						// 10 DIGITS ###-###-####
		String webAddress;						// 120 CHAR MAX
		int opensAt;							// 0000 - 2359
		int closesAt;							// 0000 - 2359
		int totalPersonnel;						// 0 - 999
		int personnelOnShift;					// 0 - 999
		int guestCount;							// 0 - 9999

		// CONSTRUCTOR
		public Zoo(  String physicalAddress,
					 String phoneNumber,
					 String faxNumber,
					 String webAddress,
					 int opensAt,
			...
			this.personnelOnShift = personnelOnShift;
	...
	private static class Asset {
		...
		// INSTANCE VARIABLES OF Assets CLASS
		String assetId;							// 7 DIGITS
		String assetName;						// 120 CHAR MAX
		String assetDescription;				// 255 CHAR MAX
		String assetClass;						// 80 CHAR MAX
		double operatingCostPerHour;			// $ _ _ _ . _ _
	...
	private static void loadData() {
		...
		while (inStream.hasNextLine()) {
			...
			{
				String assetId = data[1];
				String assetName = data[2];
				String assetDescription = data[3];
				String assetClass = data[4];
				double operatingCostPerHour = Double.parseDouble(data[5]);
			}
